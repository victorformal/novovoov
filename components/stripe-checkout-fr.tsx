        ...
        <div className="rounded-lg border border-red-200 bg-red-50 p-4">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <p className="text-sm font-semibold text-red-800">Erreur de configuration</p>
              <p className="text-xs text-red-700 mt-1">La cle Stripe n&apos;est pas configuree. Veuillez contacter le support.</p>
            </div>
          </div>
        </div>
      </div>
